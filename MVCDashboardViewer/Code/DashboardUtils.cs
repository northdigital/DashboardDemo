  ...
  public static class DashboardUtils
  {
    public static DashboardConfigurator CreateDashboardConfigurator(IConfiguration configuration, IFileProvider fileProvider)
    {
      ...
      configurator.ConfigureDataConnection += (s, e) =>
      {
        ...
        else if (e.ConnectionName == "godfather/casinodev_Connection")
        {
          var oraConParams = (OracleConnectionParameters)e.ConnectionParameters;
          oraConParams.UserName = "casinocrm";
          oraConParams.Password = "sporades";
        }
      };
      return configurator;
    }
